...
if($insert->product_insert($data,$upstatus,$gallery)>0)
{
    ...
    <table class="table">
        ...
        <tr><td>Product Name</td>
         ...
         <tr>
                <td>Sub Category</td>
                <td>
                    <?php $subcategory = isset($_POST['subcategory'])?$_POST['subcategory']:(isset($result->subcategory)?$result->subcategory:''); ?>
                    <select name="subcategory">
                                <option <?php if($subcategory==''){echo 'selected';}?> value="">Select</option>
                                <option <?php if($subcategory=='necklace'){echo 'selected';}?>  value="necklace">Necklace</option>
                                <option <?php if($subcategory=='bangles'){echo 'selected';}?>  value="bangles">Bangles</option>
                                <option <?php if($subcategory=='bracelets'){echo 'selected';}?>  value="bracelets">Bracelets</option>
                                <option <?php if($subcategory=='earings'){echo 'selected';}?>  value="earings">Earings</option>
                                <option <?php if($subcategory=='lockets'){echo 'selected';}?>  value="lockets">Lockets</option>
                                <option <?php if($subcategory=='pendents'){echo 'selected';}?>  value="pendents">Pendents</option>
                                <option <?php if($subcategory=='rings'){echo 'selected';}?>  value="rings">Rings</option>
                                <option <?php if($subcategory=='studs'){echo 'selected';}?>  value="studs">Studs</option>
                    </select></td>
            </tr>
         <tr>
                <td>Gender</td>
                <td>
                    <?php $genders = isset($_POST['gender'])?$_POST['gender']:(isset($result->gender)?$result->gender:''); ?>
                    <select name="gender">
                                <option <?php if($genders==''){echo 'selected';}?> value="">Select</option>
                                <option <?php if($genders=='female'){echo 'selected';}?>  value="female">Female</option>
                                <option <?php if($genders=='male'){echo 'selected';}?>  value="male">Male</option>
                    </select></td>
            </tr>
            
            <tr>
                <td>Collection</td>
                <td><input type="text" value="<?php echo isset($_POST['collection'])?$_POST['collection']:(isset($result->collection)?$result->collection:''); ?>" name="collection" size="40"/></td>
            </tr>
            
            <tr>
                <td>Product</td>
                <td><input type="text" value="<?php echo isset($_POST['product'])?$_POST['product']:(isset($result->product_type)?$result->product_type:''); ?>" name="product" size="40"/></td>
            </tr>
            
            <tr>
                <td>Product Code</td>
                <td><input type="text"  value="<?php echo isset($_POST['code'])?$_POST['code']:(isset($result->product_code)?$result->product_code:''); ?>" name="code" size="40"/></td>
            </tr>
            
            <tr>
                <td>Gold Karatage</td>
                <td><input type="text"  value="<?php echo isset($_POST['karat'])?$_POST['karat']:(isset($result->karatage)?$result->karatage:''); ?>" name="karat" size="40"/></td>
            </tr>
            
            <tr>
                <td>Brand</td>
                <td><input type="text" value="<?php echo isset($_POST['brand'])?$_POST['brand']:(isset($result->brand)?$result->brand:''); ?>" name="brand" size="40"/></td>
            </tr>
            
            <tr>
                <td>Making</td>
                <td><input  value="<?php echo isset($_POST['brand'])?$_POST['brand']:(isset($result->brand)?$result->brand:''); ?>" type="text" name="making" size="40"/></td>
            </tr>
            
            <tr>
                <td>Tax</td>
                <td><input type="text" name="tax"  value="<?php echo isset($_POST['tax'])?$_POST['tax']:(isset($result->tax)?$result->tax:''); ?>" size="40"/></td>
            </tr>
